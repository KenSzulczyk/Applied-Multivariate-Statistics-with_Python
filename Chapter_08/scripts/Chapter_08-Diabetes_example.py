# Chapter 8-Diabetes Example

# The response (dependent) variable is defined as:
# 
# 1 = individual has diabetest
# 0 = individual does not have diabetes
# 
# The model uses several health-related variables as inputs:
# 
# Pregnant – number of times pregnant
# Insulin – insulin level in the bloodt
# BMI (Body Mass Index) – a measure of body fat based on height and weightt
# Age – older individuals are generally at higher risk of diabetest
# Glucose – blood glucose concentration (a key indicator of diabetes)t
# BP (Blood Pressure) – diastolic blood pressuret
